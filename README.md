...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tnzl51a.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-tnzl51a.containers.anotherwebservice.com/
...
```
git clone git@github.com:0V3RL0AD/container-tnzl51a.git
cd container-tnzl51a
```
...
```
docker attach container-tnzl51a
```
